...
getsystraywidth()
{
	...
	return w ? w + systrayspacing + SYS_TRAY_GAP : 1;
}
...
togglelayout(const Arg *arg)
{
	...
	/* Update through pertag system to persist layout per tag */
...
updatesystray(void)
{
	...
	w = w ? w + systrayspacing + SYS_TRAY_GAP: 1;
	x -= w;
