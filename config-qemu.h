...
static const unsigned int focuspulse_duration_ms = 220; /* focus overlay lifetime */
...
static const unsigned int focuspulse_fake_opacity_lines = 5; /* number of fake opacity stripes */
